...
describe("OrganizationType", () => {
  ...
  test("POST /organizationTypes", async () => {
  ...
  test("GET /organizationTypes", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /organizationTypes/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/organizationTypes"}/${nonExistingId}`)
  ...
  test("GET /organizationTypes/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/organizationTypes"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
